    ...
    private void initComponents() {
                ...
                .addGroup(RegistroEmpresaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(RegistroEmpresaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addGroup(RegistroEmpresaLayout.createSequentialGroup()
                            ...
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(txtCalleSecundaria, javax.swing.GroupLayout.PREFERRED_SIZE, 60, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGroup(RegistroEmpresaLayout.createSequentialGroup()
                            .addComponent(jLabel2)
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(txtCallePrincipal, javax.swing.GroupLayout.PREFERRED_SIZE, 60, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGroup(RegistroEmpresaLayout.createSequentialGroup()
                            .addComponent(jLabel1)
                            .addGap(18, 18, 18)
                            .addComponent(txtNombreEmpresa, javax.swing.GroupLayout.PREFERRED_SIZE, 60, javax.swing.GroupLayout.PREFERRED_SIZE))))
                    ...
                    .addGroup(RegistroPostulanteLayout.createSequentialGroup()
                        ...
                        .addGroup(RegistroPostulanteLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(RegistroPostulanteLayout.createSequentialGroup()
                                ...
                                .addGap(50, 50, 50)
                                .addGroup(RegistroPostulanteLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(txtCedulaParticipante, javax.swing.GroupLayout.PREFERRED_SIZE, 74, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(txtNombreParticipante, javax.swing.GroupLayout.PREFERRED_SIZE, 74, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addGroup(RegistroPostulanteLayout.createSequentialGroup()
                                .addGroup(RegistroPostulanteLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(RegistrarEvaluadorLayout.createSequentialGroup()
                        ...
                        .addGroup(RegistrarEvaluadorLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(RegistrarEvaluadorLayout.createSequentialGroup()
                                ...
                                .addGap(31, 31, 31)
                                .addGroup(RegistrarEvaluadorLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(txtCedulaEvaluador, javax.swing.GroupLayout.PREFERRED_SIZE, 60, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(txtNombreEvaluador, javax.swing.GroupLayout.PREFERRED_SIZE, 60, javax.swing.GroupLayout.PREFERRED_SIZE)))))
                    .addGroup(RegistrarEvaluadorLayout.createSequentialGroup()
                        .addContainerGap()
        ...
        RegistrarEvaluadorLayout.setVerticalGroup(
            ...
            .addGroup(RegistrarEvaluadorLayout.createSequentialGroup()
                ...
                .addGroup(RegistrarEvaluadorLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jLabel19)
...
JOptionPane.showMessageDialog(null, "No exite ninguna Empresa Reguistrada");
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        try {
         Evaluador evaluador1=new Evaluador(txtNombreEvaluador.getText(), txtCedulaEvaluador.getText(), new Fecha(0,0,0));
         if(evaluador1.verificarDatos()){
         empresa.getEvaluadores().add(evaluador1);
         TablaEvaluadores();
         }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, "Datos vacios");
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
      ...
      ArrayList<Participante> participantes1=concurso.getEvaluador().Aprobados(concurso.getParticipantes());
     String Cabecera4[]={"Nombre","Cedula","Fecha de Nacimiento","Años de Experiencia","Profeccion"};    
        modelo4=new DefaultTableModel(null,Cabecera4);
        TablaParticipantesEvaluados.setModel(modelo4);   
      for (int i = 0; i < participantes1.size(); i++) {
            ...
            participantes1.get(i).getAnosEXperiencia(),
            participantes1.get(i).getProfesion()
            });
        }
